...
/**
* A rudimentary ASCII-based checkers game user interface.
*
...
class AsciiCheckersApp {
    public static void main(String[] args) {
        ...
        System.out.println("\n");
        PrettyBoardPrinter.print(board);
    ...
    static abstract class Move {
        ...
        public int startPos() { return sequence.get(0); }
        public int endPos()   { return sequence.get(sequence.size() - 1); }
    ...
    static class Walk extends Move {
    ...
    static class Jump extends Move {
        ...
        public void jumpAgain(int landPos) { sequence.add(landPos); }
    }

    static class Board {
        static enum PositionState {
        ...
        ArrayList<Move> possibleMoves(PlayerId p) {
    ...
    static abstract class BoardPrinter {
        public abstract void print(Board b);
    }

    static class SimpleBoardPrinter {
        public void print(Board b) {
            System.out.println(b);
        }
    }

    static class PrettyBoardPrinter {
